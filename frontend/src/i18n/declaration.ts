...
export enum I18nKey {
  ...
  SETTINGS$NAV_LLM_PROFILES = "SETTINGS$NAV_LLM_PROFILES",
  SETTINGS$ADD_LLM_PROFILE = "SETTINGS$ADD_LLM_PROFILE",
  SETTINGS$EDIT_LLM_PROFILE = "SETTINGS$EDIT_LLM_PROFILE",
  SETTINGS$DELETE_LLM_PROFILE = "SETTINGS$DELETE_LLM_PROFILE",
  SETTINGS$DELETE_LLM_PROFILE_CONFIRM = "SETTINGS$DELETE_LLM_PROFILE_CONFIRM",
  SETTINGS$DEFAULT_PROFILE_BADGE = "SETTINGS$DEFAULT_PROFILE_BADGE",
  SETTINGS$SET_AS_DEFAULT = "SETTINGS$SET_AS_DEFAULT",
  SETTINGS$LLM_PROFILE_ACTIONS = "SETTINGS$LLM_PROFILE_ACTIONS",
  SETTINGS$LLM_PROFILE_NAME_PLACEHOLDER = "SETTINGS$LLM_PROFILE_NAME_PLACEHOLDER",
  SETTINGS$LLM_PROFILES_EMPTY = "SETTINGS$LLM_PROFILES_EMPTY",
  SETTINGS$LLM_PROFILE_CREATED = "SETTINGS$LLM_PROFILE_CREATED",
  SETTINGS$LLM_PROFILE_UPDATED = "SETTINGS$LLM_PROFILE_UPDATED",
  SETTINGS$LLM_PROFILE_DELETED = "SETTINGS$LLM_PROFILE_DELETED",
  SETTINGS$LLM_PROFILE_DEFAULT_UPDATED = "SETTINGS$LLM_PROFILE_DEFAULT_UPDATED",
  SETTINGS$LLM_PROFILE_EDIT_ACTION = "SETTINGS$LLM_PROFILE_EDIT_ACTION",
  SETTINGS$LLM_PROFILES_COMMAND_TITLE = "SETTINGS$LLM_PROFILES_COMMAND_TITLE",
  SETTINGS$LLM_PROFILES_COMMAND_EMPTY = "SETTINGS$LLM_PROFILES_COMMAND_EMPTY",
